      ...
      <div className="flex items-center md:justify-between md:h-screen flex-col md:flex-row px-7 md:px-16 lg:px-28 xl:px-40">
        <div className=" w-screen h-fit px-7 py-10">
          ...
          <p className="text-sm md:text-base py-2 leading-8 text-gray-800 dark:text-gray-200">
            ...
            enthusiasm for technology and knack for creating innovative
            solutions drive me in my web development journey.
          </p>
          <p className="text-sm md:text-base py-2 leading-8 text-gray-800 dark:text-gray-200">
            I am detail-oriented and thrive in collaborative team environments.
            If you&apos;re interested in discussing opportunities or
            collaborating on projects, please feel free to reach out.
          </p>
          <p className="text-sm md:text-base py-2 leading-8 text-gray-800 dark:text-gray-200">
            Outside of work, I indulge my passion for smart home technology and
            3D printing. I am ready to contribute my expertise to dynamic web
