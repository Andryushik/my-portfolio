    ...
    <div>
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form onSubmit="" className="space-y-8">
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-teal-700 sm:w-fit hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800"
          >
            Send message
          </button>
        </form>
